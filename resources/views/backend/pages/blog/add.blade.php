		...
		<div class="row"> 
             <div class="col-sm-6">
                <div class="form-group mb-3">
                    ...
                    <br />
                    <input id="info_image_cta" type="checkbox" name="info_image_cta" value="1"> <label for="info_image_cta">Use as button</label> 
                </div>
            </div> 
            <div class="col-sm-6">
                <div class="form-group mb-3">
                    <label>Info Image Link </label>
                    <input maxlength="225" type="text" class="form-control" name="info_image_url" value="" >
                </div>
            </div>
        </div> 
		 </div>
        ...
        <div class="col-md-6">
		   ...
		   <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <textarea class="form-control trumbowyg" name="popup_content" rows="2" ></textarea> 
            </div>
