            ...
            <div class="col-md-12 mt-4">
                ...
                <div
                    ...
                    <ul class="d-flex align-items-center gap-md-5 gap-3  mb-md-0 mb-2">
                        <li><a href="{{ url(route('terms-conditions')) }}">Terms & Conditions </a></li>
                    ...
                    <ul class="d-flex align-items-center gap-3 mb-md-0 mb-3">
                        ...
                        <li>
                            <a href="{{ get_settings('facebook') }}" target="_blank" aria-label="Facebook Link"><img loading="lazy" src="assets/frontend/images/facebook.png" alt="" width="20" height="21" /></a>
                        </li>
                        <li>
                            <a href="{{ get_settings('twitter') }}" target="_blank" aria-label="Twitter Link"><img loading="lazy" src="assets/frontend/images/twitter.png" alt="" width="23" height="21" /></a>
                        </li>
                        <li>
                            <a href="{{ get_settings('linkedin') }}" target="_blank" aria-label="Twitter Link"><img loading="lazy" src="assets/frontend/images/linkedin_1.png" width="22" height="22" alt="" /></a>
                        </li>
