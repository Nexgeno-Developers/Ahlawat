            ...
            <div class="col-md-12 px0">
                            ...
                            <ul class="nav_links d-flex align-items-start gap-4 list-unstyled mb-0">
                                ...
                                <li>
                                    <a href="{{ 
                                        ...
                                        <img src="/assets/frontend/images/arrow_icon.png" alt="down Arrow" width="17" height="8" />
                                        @endif
                                    </a>
                                    @if(!$subcategory->isEmpty())
                                    <ul class="dropdown">
                ...
                <div class="wrapper">
                    <nav>
                        ...
                        <div class="logo">
                            <a href="{{ url(route('index')) }}"><img src="/assets/frontend/images/header_logo.webp" alt="logo" width="164" height="164" /></a>
                        </div>
                        ...
                        <div class="m-menu">
                            <div class="m-menu__header">
                                <div class="logo">
                                    <a href="{{ url(route('index')) }}"><img src="/assets/frontend/images/logo.png" alt="logo" width="80" height="80"  /></a>
                                </div>
                                <label class="m-menu__toggle" for="menu">
                                    ...
                                    <div class="m-menu">
                                        <div class="m-menu__header">
                                            <label class="m-menu__toggle" for="blog">
                                                <img class="width25" src="/assets/frontend/images/nex_arrow1.png" alt="logo" width="25" height="25" />
                                            </label>
                                            <span>Insights</span>
                                        </div>
                                        <ul>
