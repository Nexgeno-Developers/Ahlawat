        ...
        <div class="row">
            <div class="col-md-6 px0">
                ...
                <div class="search_right d-flex align-items-center gap-3">
                    ...
                    <div>
                        <img class="search_icon" src="/assets/frontend/images/search_icons1.png" alt="email icon"  width="29" height="29" />
                    ...
                    <div class="phone_email d-flex align-items-center gap-lg-4 gap-md-2">
                        <div>
                            <a href="tel:+91-11-4102 3400">
                                <img src="/assets/frontend/images/call.png" alt="call icon" width="17" height="17" />
                                <span class="">+91-11-4102 3400</span>
                            </a>
                        </div>
                        <div>
                            <a href="mailto:contact@ahlawatassociates.in">
                                <img src="/assets/frontend/images/email.png" alt="email icon" width="20" height="14" />
