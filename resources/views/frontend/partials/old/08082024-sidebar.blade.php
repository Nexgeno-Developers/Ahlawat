        ...
        <div class="menu_listing">
            <ul>
                ...
                <li class="sidebar_item">
                    <span class="sub-btn">Insights <img src="/assets/frontend/images/arrow_icon.png" alt="down Arrow" width="17" height="8" />
                    </span>
                    
                    <ol class="sub-menu">
                        <li><a href="{{ url(route('blog')) }}" class="sub-item">Blogs</a></li>
                        <li><a href="{{ url(route('news')) }}" class="sub-item">News Update</a></li>
                    ...
                    <div class="wcs_popup">
                        ...
                        <div class="wcs_popup_person_container">
                            <div class="wcs_popup_person" data-number="+{{ get_settings('whatsapp') }}">
                                <div class="wcs_popup_person_img"><img src="/assets/frontend/images/whats_icon1.png" alt="whatsapp" /></div>
