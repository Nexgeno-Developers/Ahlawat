...
<div class="col-lg-2 col-0 pd-0">
    <div class="menu_left_fixed">
        <div class="logo">
            <a href="{{ url(route('index')) }}"><img src="/assets/frontend/images/header_logo.webp" alt="logo"
        ...
        <div class="menu_listing">
            <ul>
                ...
                <li><a href="{{ url('https://outside-general-counsel.ahlawatassociates.com') }}" style="padding: 8px;">General Counsel Services</a></li>
