        ...
        <div class="row">
            <div class="col-md-12 px0">
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation" data-aos-once="true" data-aos="fade-up">
                        <button class="nav-link @if($a != 1) active @endif" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="@if($a != 1) true @else false @endif">
                            Why Choose Us
                        </button>
                    </li>
                    @php $a = 1; @endphp
                    ...
                    <li class="nav-item" role="presentation" data-aos-once="true" data-aos="fade-up">
                        <button class="nav-link  @if($a != 1) active @endif" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="@if($a != 1) true @else false @endif">
                            FAQ
                        </button>
                    </li>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mt-3">
                <div class="blog_big_box" data-aos-once="true" data-aos="fade-up">
                    <img rel="preload" src="{{ asset('storage/' . $row->main_image) }}" alt="blog" class="blog_img" width="390" height="116" />
