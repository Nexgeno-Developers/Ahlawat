    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 px0">
                <img src="{{ asset('storage/' . $detail->image) }}" alt="{{ ucfirst($detail->name) }}" class="team_img" data-aos="fade-up"
                    data-aos-once="true" />
            </div>
                ...
                <div class="content">
                    ...
                    <div class="d-flex align-items-center gap-3 mail ">
                        ...
                        <a href="mailto:{{ $detail->email }}">
                            <img src="/assets/frontend/images/mail.png" alt="mail" data-aos="fade-up"
                                data-aos-once="true" />
                        </a>
                        @endif
                        ...
                        <a href="{{ $detail->linkedin_link }}">
                            <img src="/assets/frontend/images/linked.png" alt="linked" data-aos="fade-up"
                                data-aos-once="true" />
                        </a>
                        @endif
