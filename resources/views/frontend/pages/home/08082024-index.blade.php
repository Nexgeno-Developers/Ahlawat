...
@if(!empty($banner)) 
    ...
    <div class="carousel-inner">
        ...
        <img loading="lazy" src="{{ asset('storage/' . $banner1) }}" class="d-block w-100" alt="..." width="1266" height="345" style="height:auto!important;">
        </div>

        
            @foreach ($banner as $row)
                <div class="carousel-item">
                <img loading="lazy" src="{{ asset('storage/' . $row) }}" class="d-block w-100" alt="..." width="1266" height="345" style="height:auto!important;">
                </div>
            @endforeach
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 px0" >
                <img loading="lazy" src="/assets/frontend/images/about_us_img_new.jpg" alt="About Us" class="about_img" width="597" height="398" style="height:auto!important;" />
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 px0">
                <div class="news_box">
                    ...
                    <img loading="lazy" src="/assets/frontend/images/india_law.jpg" alt="India Law" width="597" height="249" style="height:auto!important;"  />
