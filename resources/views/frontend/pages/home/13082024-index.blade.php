...
@if(!empty($banner)) 
    ...
    <div class="carousel-inner">
        ...
        <img src="{{ asset('storage/' . $banner1) }}" class="d-block w-100" alt="..." width="1266" height="345" style="height:auto!important;" rel="preload">
        </div>

        
            @foreach ($banner as $row)
                <div class="carousel-item">
                <img rel="preload" src="{{ asset('storage/' . $row) }}" class="d-block w-100" alt="..." width="1266" height="345" style="height:auto!important;">
                </div>
            @endforeach
...
<section class="about row">
	...
	<div class="col-md-6 px0" >
		<img rel="preload" src="/assets/frontend/images/about_us_img_new.jpg" alt="About Us" class="about_img" width="597" height="398" style="height:auto!important;" />
	</div>
</section>
...
<section class="news contentjstfy row">
            ...
            <div class="col-lg-6 px0">
                <div class="news_box">
                    ...
                    <img rel="preload" src="/assets/frontend/images/india_law.jpg" alt="India Law" width="597" height="249" style="height:auto!important;"  />
