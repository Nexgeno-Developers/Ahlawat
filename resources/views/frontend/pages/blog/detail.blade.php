...
<div class="blog_details_page_banner">
    <img rel="preload" src="{{ asset('storage/' . $detail->main_image) }}" alt="{{ $detail->alt_main_image }}" width="1266" height="371" />
        ...
        <div class="row">
            <div class="col-md-7 px0">
                <ul class="d-flex align-items-center breadcrumb gap-md-3 gap-1 list-unstyled">
                    ...
                    <li>
                        <a href="{{ url(route(''. $url.'')) }}" class="text-decoration-none">
                            {{ ucfirst($page->name) }}
                        </a>
                    </li>
                    <li>></li>
            ...
            <div class="col-md-5 px0">
                <div class="d-flex align-items-center justify-content-md-end gap-2">
                    <p class="d-flex align-items-center gap-2 author" >
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-2 col-md-2">
                <div class="avatar" >
                    <img rel="preload" src="/assets/frontend/images/usericons.jpg" alt="usericons" />
                </div>
            </div>
            ...
            <div class="col-md-12 mt-md-0 mt-4">
                <h1 class="post_heading" >Post A Comment</h1>
                <p class="post_comment" >
                    Your email address will not be published *
                </p>
                <button type="button" data-bs-toggle="modal" data-bs-target="#comment" >Post Comment</button>
            </div>
        </div>
    </div>
</section>
...
<section class="service_related">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="heading mb-4 text-center" >Related
                    {{ ucfirst($page->name) }}</h1>
            </div>
            @foreach ($blog as $row)
            <div class="col-md-4 px0 mb-3">
                <div class="blog_big_box" >
                    <img rel="preload" src="{{ asset('storage/' . $row->main_image) }}" alt="blog" class="blog_img"  width="390" height="114"/>
                    <div class="blog_content">
                        <p>{{ $row->short_description }}</p>
                        <a href="{{ url(route('blog.detail', ['category' => $url, 'slug' => strtolower(str_replace(' ', '-',$row->slug))] )) }}">View More</a>
                    </div>
                </div>
            </div>
            @endforeach
...
<style>
	.blog_details_page_banner img{height:auto!important;}
	.blog_details_page_banner{width:100%!important; height:auto!important;}
</style>