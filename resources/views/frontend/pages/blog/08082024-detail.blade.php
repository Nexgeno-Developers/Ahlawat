...
<div class="blog_details_page_banner">
    <img src="{{ asset('storage/' . $detail->main_image) }}" alt="{{ $detail->alt_main_image }}" width="1266" height="371" />
        ...
        <div class="row">
            ...
            <div class="col-md-4 px0 mb-3">
                <div class="blog_big_box" >
                    <img src="{{ asset('storage/' . $row->main_image) }}" alt="blog" class="blog_img"  width="390" height="114"/>
