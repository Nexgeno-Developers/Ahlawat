...
<div class="col-lg-4 col-md-6 px0" data-aos="fade-up" data-aos-once="true">
    <div class="blog_big_box me-xl-3 mb-md-5 mb-3 ">
        <div class="hover_effect_img">
            <img rel="preload" src="{{ asset('storage/' . $row->image) }}" alt="{{ $row->title }}" class="blog_img" data-aos="fade-up" data-aos-once="true" width="390" height="116" style="height:auto!important;" />
            <div class="overlay">
                <a href="{{ $row->url }}">
                    <div class="plus">
                        +
