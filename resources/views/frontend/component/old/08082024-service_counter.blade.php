                            ...
                            <div class="about_right_counter d-flex">
                                <div class="about_counter_icon">
                                    <div class="about_counter_img">
                                        <img src="/assets/frontend/images/trusted_icon.png" alt="counter 1" class="mb-4" width="24" height="33" />
                                    </div>
                                </div>
                    ...
                    <div class="col-md-3 col-6 second_counter">
                        <div class="about_counter_container" >
                            <div class="about_right_counter">
                                <div class="about_counter_icon">
                                    <div class="about_counter_img">
                                        <img src="/assets/frontend/images/recovered_icons.png" alt="counter 1" class="mb-4" width="24" height="33" />
                                    </div>
                                </div>
                                <div class="about_counter">
                                    <p class="about_counter_number">
                    ...
                    <div class="col-md-3 col-6 third_counter">
                        <div class="about_counter_container" >
                            <div class="about_right_counter">
                                <div class="about_counter_icon">
                                    <div class="about_counter_img">
                                        <img src="/assets/frontend/images/certified_icons.png" alt="counter 1" class="mb-4" width="24" height="33" />
                                    </div>
                                </div>
                                <div class="about_counter">
                                    <p class="about_counter_number">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="about_counter_container" >
                            <div class="about_right_counter">
                                <div class="about_counter_icon">
                                    <div class="about_counter_img">
                                        <img src="/assets/frontend/images/law_icons.png" alt="counter 1" class="mb-4" width="24" height="33" />
                                    </div>
                                </div>
                                <div class="about_counter">
                                    <p class="about_counter_number">
