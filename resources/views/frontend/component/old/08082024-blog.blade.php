                            ...
                            @foreach ($blog as $row)
                                <div class="item">
                                    <div class="blog_big_box" >
                                            <img loading="lazy" src="{{ asset('storage/' .$row->main_image) }}" alt="{{ $row->title }}" class="blog_img" width="390" height="116" />
            ...
            @foreach ($right_news as $row)
                ...
                <div class="item">
                  <div class="blog_right_box">
                    <img loading="lazy" src="{{ asset('storage/' .$row->main_image) }}" alt="{{ $row->title }}"  width="160" height="47" />
                    <div>
                        <p class="desc">
                            {{ $row->title }}
                        </p>
