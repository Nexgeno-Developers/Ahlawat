    ...
    public function practice_area_detail($slug){
        ...
        if(!empty($detail->pdf_path)){
            ...
            $cont_pdf_repl_str = '<style>
                ...
                .popup-outer{background: rgb(248,198,196); background: linear-gradient(0deg, rgba(248,198,196,1) 0%, rgba(255,255,255,1) 100%); width:750px; margin:0 auto; border-radius:15px; display:table; position:relative;}
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" align="left" class="r0-o" style="table-layout: fixed; width: 100%;">
                                                        <tr>
                                                            <td valign="top">
                                                                <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                                                    <tr>
                                                                        <td class="r8-c nl2go-default-textstyle" align="left" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 12px; line-height: 1.5; word-break: break-word; padding-top: 15px; text-align: left; valign: top;">
                                                                            <div>
