...
<?php $__env->startSection('page.name', 'Edit Privacy & Data Protection'); ?>
<?php $__env->startSection('page.content'); ?>
    <?php
        $faq = json_decode($practicearea->faq, true);
    ?>

    <form action="<?php echo e(route('practicearea.privacy.update')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row gy-3">
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="title" value="<?php echo e($practicearea->title); ?>"
                                required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="short_description"
                                value="<?php echo e($practicearea->short_description); ?>" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            <label>Slug <span class="red">*</span></label>
                            <input type="text" class="form-control" name="slug" value="<?php echo e($practicearea->slug); ?>" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select select2" name="parent_id">
                                ...
                                <?php $__currentLoopData = $allpracticearea; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($row->id); ?>" <?php if($row->id == $practicearea->parent_id): ?> selected <?php endif; ?>>
            ...
            <div class="card-body">
                <div class="col-sm-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="meta_title" value="<?php echo e($practicearea->meta_title); ?>"
                            required>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" name="meta_description" rows="3"
                            required><?php echo e($practicearea->meta_description); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="breadcrumb_title"
                                value="<?php echo e($practicearea->breadcrumb_title); ?>" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="breadcrumb_subtitle"
                                value="<?php echo e($practicearea->breadcrumb_subtitle); ?>" required>
                        </div>
                    </div>
                    <div class="col-sm-9">
                        <div class="form-group mb-3">
                ...
                <div class="row gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sections[hero][title]" class="form-control"
                            value="<?php echo e(old('sections.hero.title', $data['hero']['title'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Subtitle</label>
                        <input type="text" name="sections[hero][subtitle]" class="form-control"
                            value="<?php echo e(old('sections.hero.subtitle', $data['hero']['subtitle'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Book Now Button URL</label>
                        <input type="text" name="sections[hero][button_url]" class="form-control"
                            value="<?php echo e(old('sections.hero.button_url', $data['hero']['button_url'] ?? '')); ?>">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        <?php if(!empty($data['hero']['image'])): ?>
                            <input type="hidden" name="sections[hero][image]" value="<?php echo e($data['hero']['image']); ?>">
                            
                            <img src="<?php echo e(asset('storage/' . $data['hero']['image'])); ?>" class="img-thumbnail mt-2"
                ...
                <div class="row mb-3 gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sections[intro][title]" class="form-control"
                            value="<?php echo e(old('sections.intro.title', $data['intro']['title'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Section Subtitle</label>
                        <input type="text" name="sections[intro][subtitle]" class="form-control"
                            value="<?php echo e(old('sections.intro.subtitle', $data['intro']['subtitle'] ?? '')); ?>">
                    </div>
                </div>
                <div id="intro-container">
                    <?php $__currentLoopData = old('sections.intro.texts', $data['intro']['texts'] ?? ['']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="intro-row row my-2 gy-2 align-items-start">
                            <div class="col-1">
                                <strong class="item-no"><?php echo e($idx + 1); ?>.</strong>
                            </div>
                            <div class="col-10">
                                <textarea name="sections[intro][texts][]" class="form-control trumbowyg"><?php echo e($text); ?></textarea>
                            </div>
                            <div class="col-1">
                ...
                <div class="row mb-3 gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sections[sectors][title]" class="form-control"
                            value="<?php echo e(old('sections.sectors.title', $data['sectors']['title'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Section Subtitle</label>
                        <input type="text" name="sections[sectors][subtitle]" class="form-control"
                            value="<?php echo e(old('sections.sectors.subtitle', $data['sectors']['subtitle'] ?? '')); ?>">
                    </div>
                </div>
                <div id="sectors-container">
                    <?php $__currentLoopData = old('sections.sectors.items', $data['sectors']['items'] ?? [['title' => '', 'text' => '', 'icon' => '']]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="sector-row row my-2 gy-2 align-items-start">
                            <div class="col-1">
                                <strong class="item-no"><?php echo e($idx + 1); ?>.</strong>
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="sections[sectors][items][][title]" class="form-control"
                                    value="<?php echo e($item['title'] ?? ''); ?>" placeholder="Card Title">
                            </div>
                            <div class="col-md-4">
                                <textarea name="sections[sectors][items][][text]" class="form-control trumbowyg"
                                    placeholder="Card Text"><?php echo e($item['text'] ?? ''); ?></textarea>
                            </div>
                            <div class="col-md-3">
                                <input type="file" name="sections[sectors][items][][icon]" class="form-control">
                                <?php if(!empty($item['icon'])): ?>
                                    <input type="hidden" name="sections[sectors][items][][icon]" value="<?php echo e($item['icon']); ?>">
                                    <small>Current: <?php echo e(basename($item['icon'])); ?></small><br>
                                    <img src="<?php echo e(asset('storage/' . $item['icon'])); ?>" class="img-thumbnail"
                ...
                <div class="row mb-3 gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sections[assist][title]" class="form-control"
                            value="<?php echo e(old('sections.assist.title', $data['assist']['title'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Section Subtitle</label>
                        <input type="text" name="sections[assist][subtitle]" class="form-control"
                            value="<?php echo e(old('sections.assist.subtitle', $data['assist']['subtitle'] ?? '')); ?>">
                    </div>
                </div>
                <div id="assist-container">
                    <?php $__currentLoopData = old('sections.assist.items', $data['assist']['items'] ?? [['icon' => '', 'title' => '', 'text' => '', 'button_url' => '']]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="assist-row row my-2 gy-2 align-items-start">
                            <div class="col-1">
                                <strong class="item-no"><?php echo e($idx + 1); ?>.</strong>
                            </div>
                            ...
                            <div class="col-md-2">
                                <input type="text" name="sections[assist][items][][button_url]" class="form-control"
                                    value="<?php echo e($item['button_url'] ?? ''); ?>" placeholder="Button URL">
                            </div>
                            <div class="col-md-2">
                                <input type="file" name="sections[assist][items][][icon]" class="form-control">
                                <?php if(!empty($item['icon'])): ?>
                                    <input type="hidden" name="sections[assist][items][][icon]" value="<?php echo e($item['icon']); ?>">
                                    <small>Current: <?php echo e(basename($item['icon'])); ?></small><br>
                                    <img src="<?php echo e(asset('storage/' . $item['icon'])); ?>" class="img-thumbnail"
                                        style="max-height: 60px;">
                                <?php endif; ?>
            ...
            <div class="card-body">
                <div class="row mb-3 gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sections[process][title]" class="form-control"
                            value="<?php echo e(old('sections.process.title', $data['process']['title'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Section Subtitle</label>
                        <input type="text" name="sections[process][subtitle]" class="form-control"
                            value="<?php echo e(old('sections.process.subtitle', $data['process']['subtitle'] ?? '')); ?>">
                    </div>
                </div>
                <div id="process-container">
                    <?php $__currentLoopData = old('sections.process.items', $data['process']['items'] ?? [['title' => '', 'text' => '']]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="process-row row my-2 gy-2 align-items-start">
                            <div class="col-1">
                                <strong class="item-no"><?php echo e($idx + 1); ?>.</strong>
                            </div>
                            <div class="col-md-4">
                                <input type="text" name="sections[process][items][][title]" class="form-control"
                                    value="<?php echo e($item['title']); ?>" placeholder="Step Title">
                            </div>
                            <div class="col-md-6">
                                <textarea name="sections[process][items][][text]" class="form-control trumbowyg"
                                    placeholder="Step Description"><?php echo e($item['text']); ?></textarea>
                            </div>
                            <div class="col-md-1">
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="remove-parent"
                ...
                <div class="mb-3">
                    ...
                    <textarea name="sections[process][paragraph]"
                        class="form-control trumbowyg"><?php echo e(old('sections.process.paragraph', $data['process']['paragraph'] ?? '')); ?></textarea>
                </div>
            </div>
        </div>
                ...
                <div class="row mb-3 gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sections[penalties][title]" class="form-control"
                            value="<?php echo e(old('sections.penalties.title', $data['penalties']['title'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Section Subtitle</label>
                        <input type="text" name="sections[penalties][subtitle]" class="form-control"
                            value="<?php echo e(old('sections.penalties.subtitle', $data['penalties']['subtitle'] ?? '')); ?>">
                    </div>
                </div>
                <div id="penalties-container">
                    <?php $__currentLoopData = old('sections.penalties.items', $data['penalties']['items'] ?? [['title' => '', 'text' => '']]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="penalty-row row my-2 gy-2 align-items-start">
                            <div class="col-1">
                                <strong class="item-no"><?php echo e($idx + 1); ?>.</strong>
                            </div>
                ...
                <div class="row mb-3 gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sections[case_studies][title]" class="form-control"
                            value="<?php echo e(old('sections.case_studies.title', $data['case_studies']['title'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Section Subtitle</label>
                        <input type="text" name="sections[case_studies][subtitle]" class="form-control"
                            value="<?php echo e(old('sections.case_studies.subtitle', $data['case_studies']['subtitle'] ?? '')); ?>">
                    </div>
                </div>
                <div id="cs-container">
                    <?php $__currentLoopData = old('sections.case_studies.items', $data['case_studies']['items'] ?? [['title' => '', 'subtitle' => '', 'text' => '']]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="cs-row row my-2 gy-2 align-items-start">
                            <div class="col-1">
                                <strong class="item-no"><?php echo e($idx + 1); ?>.</strong>
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="sections[case_studies][items][][title]" class="form-control"
                                    value="<?php echo e($item['title']); ?>" placeholder="Slide Title">
                            </div>
                            <div class="col-md-3">
                                <input type="text" name="sections[case_studies][items][][subtitle]" class="form-control"
                                    value="<?php echo e($item['subtitle'] ?? ''); ?>" placeholder="Slide Subtitle">
                            </div>
                            <div class="col-md-3">
                                <textarea name="sections[case_studies][items][][text]" class="form-control trumbowyg"
                                    placeholder="Slide Text"><?php echo e($item['text']); ?></textarea>
                            </div>
                            <div class="col-md-1">
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="remove-parent"
                ...
                <div class="row mb-3 gy-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sections[whyus][title]" class="form-control"
                            value="<?php echo e(old('sections.whyus.title', $data['whyus']['title'] ?? '')); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Section Subtitle</label>
                        <input type="text" name="sections[whyus][subtitle]" class="form-control"
                            value="<?php echo e(old('sections.whyus.subtitle', $data['whyus']['subtitle'] ?? '')); ?>">
                    </div>
                </div>
                <div id="whyus-container">
                    <?php $__currentLoopData = old('sections.whyus.items', $data['whyus']['items'] ?? [['icon' => '', 'title' => '', 'text' => '']]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="whyus-row row my-2 gy-2 align-items-start">
                            <div class="col-1">
                                <strong class="item-no"><?php echo e($idx + 1); ?>.</strong>
                            </div>
                            ...
                            <div class="col-md-3">
                                <input type="file" name="sections[whyus][items][][icon]" class="form-control">
                                <?php if(!empty($item['icon'])): ?>
                                    <input type="hidden" name="sections[whyus][items][][icon]" value="<?php echo e($item['icon']); ?>">
                                    <small>Current: <?php echo e(basename($item['icon'])); ?></small><br>
                                    <img src="<?php echo e(asset('storage/' . $item['icon'])); ?>" class="img-thumbnail"
                                        style="max-height: 60px;">
                                <?php endif; ?>
        ...
        <div class="card my-3">
            ...
            <div class="card-body">
                <select class="form-select select2" name="focus_area[]" multiple>
                    ...
                    <?php $__currentLoopData = $allpracticearea; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($row->id); ?>" <?php if(in_array($row->id, json_decode($practicearea->focus_area, true))): ?>
                        selected <?php endif; ?>>
                            <?php echo e($row->title); ?>
            ...
            <div class="card my-3">
                ...
                <div class="card-body">
                    <div id="faq-container">
                        <?php $__currentLoopData = old('faq', $faq ?? [['question' => '', 'answer' => '']]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="faq-row row my-2 gy-2 align-items-start">
                                <div class="col-1">
                                    <strong class="item-no"><?php echo e($idx + 1); ?>.</strong>
                                </div>
                                <div class="col-md-5">
                                    <input type="text" name="faq[]" class="form-control" value="<?php echo e($item['question'] ?? ''); ?>"
                                        placeholder="Enter Question here...">
                                </div>
                                <div class="col-md-5">
                                    <textarea name="faq_description[]" class="form-control trumbowyg" rows="5"
                                        placeholder="Enter Answer here..."><?php echo e($item['answer'] ?? ''); ?></textarea>
                                </div>
                                <div class="col-md-1">
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="remove-parent"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abc\Desktop\ahlawat new\resources\views/backend/pages/practicearea/privacy_data_protection/edit.blade.php ENDPATH**/ ?>