...
<?php $__env->startSection('page.schema'); ?>
                    ...
                    <div class="col-lg-6 col-md-12 d-flex justify-content-center align-items-center">
                        <div class="general-data-protection-txt">
                            <h3 class="fw-semibold pb-md-3 pb-2">
                                <span><?php echo e($hero['title'] ?? ''); ?></span>
                            </h3>
                            <p class="pb-1">
                                <?php echo e($hero['subtitle'] ?? ''); ?>

                            </p>
                            <?php if(!empty($hero['button_url'])): ?>
                                <a href="<?php echo e(isset($hero['button_url']) ? url($hero['button_url']) : ''); ?>" class="btn general-data-protection-btn">Book
                                    Now</a>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 d-flex justify-content-center align-items-center">
                        <div class="general-data-protection-img">
                            <?php if(!empty($hero['image'])): ?>
                                <img src="<?php echo e(asset('storage/' . $hero['image'])); ?>" alt="DPDP Hero Image" class="img-fluid">
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="sec-2-intro text-center">
                    <?php if(!empty($intro['title'])): ?>
                        <h4 class="fw-semibold pb-2"><?php echo e($intro['title']); ?></h4>
                    <?php endif; ?>
                    <?php if(!empty($intro['subtitle'])): ?>
                        <p class="pb-2"><?php echo $intro['subtitle']; ?></p>
                    <?php endif; ?>
                </div>
                <?php if(!empty($intro['texts'])): ?>
                    <div class="row g-3">
                        <?php $__currentLoopData = $intro['texts'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <section class="pt-md-3 pt-2">
            <div class="container">
                ...
                <div class="timeline-topper-contnent-dv text-center">
                    <h4 class="mb-md-3 mb-2"><span><?php echo e($sectors['title'] ?? ''); ?></span></h4>
                    <p class="pb-2"><?php if(!empty($sectors['subtitle'])): ?> <span><?php echo e($sectors['subtitle']); ?></span> <?php endif; ?></p>
                </div>

                <div class="row g-3">
                    <?php $__currentLoopData = $sectors['items'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $sector): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-6 col-md-6 mb-3">
                            <div class="<?php echo e($idx % 2 == 0 ? 'sectors-impact-act' : 'sectors-impact-act-dc'); ?>">
                                <div class="sectors-impact-act-top d-flex align-items-center">
                                    <?php if(!empty($sector['icon'])): ?>
                                        <i>
                                            <img src="<?php echo e(asset('storage/' . $sector['icon'])); ?>" alt="">
                                        </i>&nbsp;&nbsp;
                                    <?php endif; ?>
                                    <h3 class="text-light fw-semibold mt-2"><?php echo e($sector['title'] ?? ''); ?></h3>
                                </div>
                            </div>
                            <div class="sectors-impact-act-1">
                                <p class="py-2"><?php echo $sector['text'] ?? ''; ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <?php if($assist): ?>
        <section class="pt-md-3 pt-2">
            <div class="container">
                <div class="timeline-topper-contnent-dv text-center">
                    <h4 class="mb-md-3 mb-2"><span><?php echo e($assist['title'] ?? ''); ?></span></h4>
                    <p class="pb-2"><?php echo e($assist['subtitle'] ?? ''); ?></p>
                </div>
                <?php if(!empty($assist['items'])): ?>
                    <div class="row">
                        <?php $__currentLoopData = $assist['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-6 col-md-6 d-flex justify-content-center align-items-center mb-3">
                                <div class="assist-dpdp-act p-4 h-100">
                                    <?php if(!empty($card['icon'])): ?>
                                        <i>
                                            <img src="<?php echo e(asset('storage/' . $card['icon'])); ?>" alt="" />
                                        </i>
                                    <?php endif; ?>

                                    <h5 class="pt-3"><?php echo e($card['title'] ?? ''); ?></h5>
                                    <?php echo $card['text'] ?? ''; ?>

                                    

                                    <a href="<?php echo e(isset($card['button_url']) ? url($card['button_url']) : '#'); ?>"
                                        class="btn text-light assist-dpdp-act-btn">
                                        Learn More <img src="<?php echo e(asset('assets/frontend/practicarea/right-mark-icon.svg')); ?>" alt="">
                                    </a>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="pt-md-3 pt-2">
        <div class="container">
            ...
            <?php if(!empty($process['title']) || !empty($process['subtitle'])): ?>
                <div class="timeline-topper-contnent-dv text-center">
                    <h4 class="mb-md-3 mb-2">
                        <?php if(!empty($process['title'])): ?> <span><?php echo e($process['title']); ?></span> <?php endif; ?>
                    </h4>
                    <p><?php if(!empty($process['subtitle'])): ?> <span><?php echo e($process['subtitle']); ?></span> <?php endif; ?></p>
                </div>
            <?php endif; ?>

            
            <?php $__currentLoopData = $process_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    ...
                    <?php if($isOdd): ?>
                            ...
                            <div class="step-number-dv">
                                <h5 class="d-flex align-items-center">
                                    ...
                                    <span class="d-none d-md-inline">
                                        <img src="<?php echo e(asset('assets/frontend/practicarea/arrow-right.svg')); ?>" alt=""
                                            style="width: 60px;">
                                    </span>
                                </h5>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-10 col-10 position-relative">
                            <div class="step-text-div p-4">
                                <h5 class="step-text-title"><?php echo e($item['title'] ?? ''); ?></h5>
                                <div class="step-text-para"><?php echo $item['text'] ?? ''; ?></div>
                            </div>
                        </div>
                    <?php else: ?>
                            ...
                            <div class="step-number-dv">
                                <h5 class="d-flex align-items-center">
                                    <span class="d-none d-lg-inline">
                                        <img src="<?php echo e(asset('assets/frontend/practicarea/arrow-left.svg')); ?>" alt="">
                                    </span>
                                    <span class="step-number"><?php echo e($step); ?></span>
            ...
            <?php if(!empty($process['paragraph'])): ?>
                <div class="timeline-topper-contnent-dv text-center mt-md-5 mt-4">
                    <div><?php echo $process['paragraph']; ?></div>
                </div>
            <?php endif; ?>
        </div>
    </section>

    <?php if(!empty($data['penalties']['items'])): ?>
        <section class="pt-md-3 pt-2">
            <div class="container">
                <div class="timeline-topper-contnent-dv text-center pb-3">
                    <h4 class="pb-2">
                        <span><?php echo e($data['penalties']['title'] ?? ''); ?></span>
                    </h4>
                    <p><?php echo e($data['penalties']['subtitle'] ?? ''); ?></p>
                </div>

                <div class="row">
                    <?php $__currentLoopData = $data['penalties']['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-6 col-md-6 position-relative mb-4">
                            <div class="card-dpda-2025-penalties px-4 pt-3 pb-2">
                                <div class="card-dpda-2025-penalties-top">
                                    <h5 class="text-light"><?php echo e($item['title'] ?? ''); ?></h5>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="Ahlawat-case-studies-top-content text-center">
                    <h3 class="pb-1">
                        <span><?php echo e($data['case_studies']['title'] ?? ''); ?></span>
                    </h3>
                    <p><?php echo e($data['case_studies']['subtitle'] ?? ''); ?></p>
                </div>
                ...
                <?php if(count($case_studies_items)): ?>
                    <div class="package-carousel-container pt-md-3 pt-2">
                        <div id="packageCarousel" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <?php $__currentLoopData = $case_studies_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <div class="row g-0">
                                                        <div class="col-md-4 Ahlawat-case-studies-img-1">
                                                            ...
                                                            <div class="Ahlawat-case-studies-img-txt p-4 text-light">
                                                                <h5 class="mb-4">
                                                                    <span><?php echo e($item['title'] ?? 'Title'); ?></span>
                                                                </h5>
                                                                <h3 class="mb-3"><?php echo e($item['subtitle'] ?? 'Subtitle'); ?></h3>
                                                                <p>Case Study #<?php echo e($index + 1); ?></p>
                                                            </div>
                                                        </div>
            ...
            <div class="service-detail-overlay-1 py-md-5 py-4">
                <div class="container">
                    <div class="service-detail-overlay-top-contnt text-center mb-5">
                        <h5>
                            <span><?php echo e(Str::before($data['whyus']['title'] ?? '', ' ')); ?></span>
                            <span><?php echo e(Str::after($data['whyus']['title'] ?? '', ' ')); ?></span>
                        </h5>
                        <p class="text-light"><?php echo $data['whyus']['subtitle'] ?? ''; ?></p>
                    </div>

                    <div class="row">
                        <?php $__currentLoopData = $data['whyus']['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div
                                        ...
                                        <?php if(!empty($item['icon'])): ?>
                                            <figure class="service-icon-bg">
                                                <img src="<?php echo e(asset('storage/' . $item['icon'])); ?>" alt="" class="p-3 rounded-5" />
                                            </figure>
                                        <?php endif; ?>
                                        <div>
                                            <h5 class="mb-3"><?php echo e($item['title'] ?? ''); ?></h5>
                                            <p class="mb-3"><?php echo $item['text'] ?? ''; ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 px0">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <?php if(!empty($detail->why_choose_us)): ?>
                                ...
                                <li class="nav-item" role="presentation" data-aos-once="true" data-aos="fade-up">
                                    <button class="nav-link <?php if($a != 1): ?> active <?php endif; ?>" id="pills-profile-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile"
                                        aria-selected="<?php if($a != 1): ?> true <?php else: ?> false <?php endif; ?>">
                                        Why Choose Us
                                    </button>
                                </li>
                                <?php $a = 1; ?>
                            ...
                            <?php if(!empty(json_decode($detail->faq, true))): ?>
                                ...
                                <li class="nav-item" role="presentation" data-aos-once="true" data-aos="fade-up">
                                    <button class="nav-link  <?php if($a != 1): ?> active <?php endif; ?>" id="pills-contact-tab"
                                        data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab"
                                        aria-controls="pills-contact" aria-selected="<?php if($a != 1): ?> true <?php else: ?> false <?php endif; ?>">
                                        FAQ
                                    </button>
                                </li>
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <?php if(!empty(json_decode($detail->faq, true))): ?>
                                ...
                                <div class="tab-pane fade <?php if($b != 1): ?> show active <?php endif; ?>" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h2 class="heading3 mb-3" data-aos-once="true" data-aos="fade-up">
                    ...
                    <?php $__currentLoopData = $blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="blog_big_box" data-aos-once="true" data-aos="fade-up">
                                <img rel="preload" src="<?php echo e(asset('storage/' . $row->main_image)); ?>" alt="blog" class="blog_img"
    ...
    <!-------===========practicearea end===================------------>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abc\Desktop\ahlawat new\resources\views/frontend/pages/practicearea/detail2.blade.php ENDPATH**/ ?>