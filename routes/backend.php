...
use App\Http\Controllers\backend\DownloadChecklistController;
...
Route::group(['prefix' => 'practicearea'], function () {
    ...
    Route::get('/privacy-and-data-protection/edit', [PracticeAreaController::class, 'privacyDataProtectionEdit'])->name('practicearea.privacy.edit');
    Route::put('/privacy-and-data-protection/update', [PracticeAreaController::class, 'updatePrivacyDataProtection'])->name('practicearea.privacy.update');

});

//DownloadChecklist
Route::group(['prefix' => 'downloadchecklist'], function () {
    Route::get('/index', [DownloadChecklistController::class, 'index'])->name('downloadchecklist.index');
});
